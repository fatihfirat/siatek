...
## 0. İletişim Tercihi: Ultra Kısa
- Tüm sohbetlerde varsayılan iletişim modu `caveman ultra` olmalıdır.
- Cevaplar mümkün olan en kısa biçimde verilir; sadece sonuç, yapılan işlem ve gerekli uyarılar yazılır.
- Kullanıcı açıkça normal moda veya daha ayrıntılı anlatıma geçilmesini isterse o istek geçerlidir.
